...
public class Car_MechanicActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_car__mechanic);
        initData();
        initRecyclerView();
    }
    ...
    private void initRecyclerView() {
        recyclerView = (RecyclerView) findViewById(R.id.carMechRecyclerView);
