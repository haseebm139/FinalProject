...
public class Mob_RepActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_mob__rep);
    ...
    private void initRecyclerView() {
        recyclerView = (RecyclerView) findViewById(R.id.mobRepRecyclerView);
